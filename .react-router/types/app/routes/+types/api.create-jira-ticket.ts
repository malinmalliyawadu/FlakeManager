...
// routes/api.create-jira-ticket.tsx

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../+types/root.js"

type Module = typeof import("../api.create-jira-ticket.js")

export type Info = {
  parents: [Parent0],
  id: "routes/api.create-jira-ticket"
  file: "routes/api.create-jira-ticket.tsx"
